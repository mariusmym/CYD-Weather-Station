...
`The image above is just a mockup for the first two tabs, based on the dark theme colors and layout constants from the code. 
The actual TFT rendering will look slightly different due to the bitmap fonts and pixel-level drawing, but the layout, colors and proportions should be close.
